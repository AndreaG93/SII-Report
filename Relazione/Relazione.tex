...
Le analisi condotte dalla NCCIC hanno dimostrato che gli attaccanti, per mezzo del suddetto malware, sono riusciti a trasferire un \textbf{injection tool} all'interno dei server di payment switch delle banche coinvolte dell'attacco; analizzeremo in dettaglio l'injection injection tool di FASTCash nella sezione \ref{processoinjection}.
...
Ovviamente tale soluzione è lungi da essere una panacea in quanto costosa e onerosa dal punto computazionale e, nonostante ciò, non garantisce completa immunità agli attacchi.

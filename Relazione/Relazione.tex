...
\section{anti-phishingdsfdfsd}

Esistono diverse tecniche per combattere il phishing, tra cui la legislazione e la tecnologia create appositamente per proteggere dal phishing. Queste tecniche includono le misure che possono essere adottate da singoli individui e dalle organizzazioni. Telefono, sito web ed e-mail di phishing possono ora essere segnalati alle autorità, come descritto di seguito.

Formazione dell'utente

Le persone possono essere addestrate a riconoscere i tentativi di phishing e ad affrontarli attraverso una varietà di approcci. Tale educazione può essere efficace, specialmente laddove la formazione enfatizza la conoscenza concettuale e fornisce un feedback diretto.
...
Le persone possono adottare misure per evitare tentativi di phishing modificando leggermente le loro abitudini di navigazione. Quando viene contattato per un account che deve essere "verificato" (o qualsiasi altro argomento usato dai phisher), è una precauzione ragionevole contattare l'azienda da cui sembra provenire l'email per verificare che l'email sia legittima. In alternativa, l'indirizzo che l'utente conosce è il sito Web originale dell'azienda può essere digitato nella barra degli indirizzi del browser, invece di fidarsi di eventuali collegamenti ipertestuali nel messaggio di phishing sospetto.
